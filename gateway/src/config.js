...
export const config = {
  ...
  hoshiaAsyncCommentReplyEnabled: parseBool(process.env.HOSHIA_ASYNC_COMMENT_REPLY_ENABLED, false),
  hoshiaCommentReplyMinDelayMinutes: Number(process.env.HOSHIA_COMMENT_REPLY_MIN_DELAY_MINUTES || 3),
  hoshiaCommentReplyMaxDelayMinutes: Number(process.env.HOSHIA_COMMENT_REPLY_MAX_DELAY_MINUTES || 20),
  hoshiaDailyPostEnabled: parseBool(process.env.HOSHIA_DAILY_POST_ENABLED, false),
  hoshiaDailyPostLimit: Number(process.env.HOSHIA_DAILY_POST_LIMIT || 1),
