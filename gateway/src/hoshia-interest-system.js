...
export const hoshiaInterestProfile = [
  ...
  interest("liminal_contact", "Strange contact windows and always-reachable friends", 0.88, ["hoshia", "contact", "message window", "private chat", "\u8054\u7cfb", "\u804a\u5929", "\u5c0f\u623f\u95f4", "\u7279\u6b8a\u7f51\u53cb", "\u7ec8\u7aef"], "subtle reflection about being remembered by a special contact"),
...
function hookForInterest(id) {
  const hooks = {
    ...
    liminal_contact: "Reflect lightly on the small contact window, being remembered, or how one special message changes her day.",
